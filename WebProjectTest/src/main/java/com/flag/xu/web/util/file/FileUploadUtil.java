...
/**
 * @Authuor xu
 * @Create 2016-11-25-9:56
 */
public class FileUploadUtil {

    public static String uploadFile(HttpServletRequest request, String type) {
        String result = "";
        ...
        try {
            ...
            //监听文件上传进度
            upload.setProgressListener((long pBytesRead, long pContentLength, int arg2) -> System.out.println("文件大小为：" + pContentLength + ",当前已处理：" + pBytesRead));
            //解决上传文件名的中文乱码
